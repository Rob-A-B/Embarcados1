...
int main(void)
{
  ...
  // Defina limites para a deadzone do joystick
  // Inicialize a posição inicial do LED aceso
  int posX = 0; // Posição X inicial (0 a 1)
  int posY = 0; // Posição Y inicial (0 a 1)

  // Limiares para o movimento do joystick
  ...
  // Função para acender o LED na posição (posX, posY)
  ...
  // Função para ler o valor do joystick e ajustar a posição do LED
  void lerJoystick() {
